...
@Require(MaidPermission.IPBAN)
public class IPBanCommand extends MaidCommand {

    @Command(name = "", desc = "IP封鎖一位玩家")
    public void root(@Sender CommandSender sender, String targetName, String duration, @Text String reason) {
        ...
        plugin.getPunishmentManager().punish(sender, targetUUID, IPunishment.PunishmentType.IP_BAN, duration, reason);
    }

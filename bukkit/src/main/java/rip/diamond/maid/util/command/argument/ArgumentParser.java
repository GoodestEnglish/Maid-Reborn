package rip.diamond.maid.util.command.argument;

import com.google.common.base.Preconditions;
import rip.diamond.maid.util.command.annotation.Flag;
import rip.diamond.maid.util.command.command.CommandExecution;
import rip.diamond.maid.util.command.command.CommandFlag;
import rip.diamond.maid.util.command.command.DrinkCommand;
import rip.diamond.maid.util.command.command.DrinkCommandService;
import rip.diamond.maid.util.command.exception.CommandArgumentException;

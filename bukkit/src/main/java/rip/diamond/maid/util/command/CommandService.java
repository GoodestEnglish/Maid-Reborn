package rip.diamond.maid.util.command;

import org.bukkit.plugin.java.JavaPlugin;
import rip.diamond.maid.util.command.command.DrinkAuthorizer;
import rip.diamond.maid.util.command.command.DrinkCommandContainer;
import rip.diamond.maid.util.command.modifier.DrinkModifier;
...
public interface CommandService {
     ...
     * @param handler Object that has the {@link rip.diamond.maid.util.command.annotation.Command} annotated methods
     ...
     * {@link rip.diamond.maid.util.command.annotation.Command} annotation set name = ""
     ...
     * @param handler The object that has the {@link rip.diamond.maid.util.command.annotation.Command}
    ...
    /**
     * Start binding a class type to a {@link rip.diamond.maid.util.command.parametric.DrinkProvider} or instance.
     ...
     * @param annotation The annotation to use for the modifier (must have {@link rip.diamond.maid.util.command.annotation.Modifier} annotated in it's class)

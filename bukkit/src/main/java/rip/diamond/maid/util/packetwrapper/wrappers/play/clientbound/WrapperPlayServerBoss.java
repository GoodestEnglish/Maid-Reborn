...
public class WrapperPlayServerBoss extends AbstractPacket {
     ...
     * The operation can be casted to any of specific operation types (e.g. {@see rip.diamond.maid.util.packetwrapper.wrappers.play.clientbound.WrapperPlayServerBoss.WrappedBossBarAddOperation}) based
     ...
     * @see WrappedBossBarAddOperation#create(WrappedChatComponent, float, BarColor, BarStyle, boolean, boolean, boolean)
     * @see WrappedBossBarRemoveOperation#create()
     * @see WrappedBossBarProgressOperation#create(float)
     * @see WrappedBossBarUpdatePropertiesOperation#create(boolean, boolean, boolean)
     * @see WrappedBossBarUpdateStyleOperation#create(BarColor, BarStyle)
     * @see WrappedBossBarUpdateNameOperation#create(WrappedChatComponent)
     */

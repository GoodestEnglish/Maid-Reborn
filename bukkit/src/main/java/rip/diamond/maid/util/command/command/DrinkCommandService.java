...
import rip.diamond.maid.util.command.annotation.Duration;
import rip.diamond.maid.util.command.annotation.Sender;
import rip.diamond.maid.util.command.annotation.Text;
import rip.diamond.maid.util.command.argument.ArgumentParser;
import rip.diamond.maid.util.command.argument.CommandArgs;
import rip.diamond.maid.util.command.exception.*;
import rip.diamond.maid.util.command.modifier.DrinkModifier;
import rip.diamond.maid.util.command.modifier.ModifierService;
import rip.diamond.maid.util.command.parametric.BindingContainer;
import rip.diamond.maid.util.command.parametric.DrinkBinding;
...
public class DrinkCommandService implements CommandService {
    ...
    private void bindDefaults() {
        ...
        bind(long.class).toProvider(LongProvider.INSTANCE);
        bind(String.class).toProvider(new StringProvider(plugin));

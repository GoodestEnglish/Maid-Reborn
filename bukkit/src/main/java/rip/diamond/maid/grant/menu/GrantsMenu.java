    ...
    class GrantButton extends ConversationButton {
        ...
        public BiConsumer<ConversationContext, String> getAction() {
            return (cc, reason) -> {
                ...
                PacketUtil.send(new PermissionUpdatePacket(Maid.API.getPlatform().getServerID(), target.getUniqueID()));
            ...
            if (grant.isActive()) {
                ...
                builder = new ItemBuilder(Material.RED_WOOL)
                        ...
                        .lore(
                                ...
                                CC.WHITE + " 移除時間: " + CC.AQUA + TimeUtil.formatDate(grant.getRevokedAt())
                        );
            }
